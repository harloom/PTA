package com.coverteam.pta.tools.signatureview.utils

import Bezier
import com.coverteam.pta.tools.signatureview.SvgPathBuilder
...
internal class SvgBuilder {
    ...
    fun build(width: Int, height: Int,customWidth :Int,  customHeight : Int): String {
        if (isPathStarted) {
            appendCurrentPath()
        }
