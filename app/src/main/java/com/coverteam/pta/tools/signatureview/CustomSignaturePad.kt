...
import com.coverteam.pta.tools.signatureview.utils.ControlTimedPoints
import com.coverteam.pta.tools.signatureview.utils.SvgBuilder
import com.coverteam.pta.tools.signatureview.utils.TimedPoint
...
class CustomSignaturePad(context: Context, attrs: AttributeSet?) : View(context, attrs) {
    ...
    fun getSignatureSvg(customWidth :Int,  customHeight : Int): String {

        val width = mSignatureTransparentBitmap!!.width
        val height = mSignatureTransparentBitmap!!.height
        return mSvgBuilder.build(width, height,customWidth,customHeight)
    }
